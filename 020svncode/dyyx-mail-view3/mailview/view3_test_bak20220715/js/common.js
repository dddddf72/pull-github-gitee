...
function getUserId () { //获取userId
  ...
  if (userId == ""||userId == ''||userId == null) {
    userId = "88888888888888888";//现网88888888888888888，之前测试版本用0
  }
console.log('common.js---userId'+userId)
  ...
  //} catch (err) {
  //}
  //return userId || '88888888888888888';
}
...
function cardBachu () {
  setGlobalVar('userId', '8120010480205746');//现网用8120010480205746，之前测试版本8120010480205746，svn上88888888888888888
}
