...
TimeControl.prototype.imgTCLen = function () {
	return document.getElementById("imgTimeControl");
};
TimeControl.prototype.imgTCPos = function () {
	return document.getElementById("cicle");
};
...
TimeControl.prototype.init = function (parentObj, beginTime, endTime, startTime) {
	...
	if (window.navigator.userAgent != 'compatible:Coship cooca Webkit') {
		var hl = "<p id=\"g_c\"><img id=\"imgTimeControl\" src=\"" + prefix + "images/g_c.png\" width=\"0\" height=\"14\" /></p><p><img id=\"cicle\" src=\"" + prefix + "images/circle.png\" width=\"33\" height=\"35\" /></p>";
	} else {
		var hl = "<p id=\"g_c_coship\"><img id=\"imgTimeControl\" src=\"" + prefix + "images/g_c.png\" width=\"0\" height=\"14\" /></p><p><img id=\"cicle\" src=\"" + prefix + "images/circle.png\" width=\"33\" height=\"35\" /></p>";
	}
	if (parentObj) {
...
TimeControl.prototype.resetEndTime = function (beginTime, endTime) {
	...
	if (beginTime != null && endTime != null) {
		...
		if (this.allTimes < 0) {
			...
			this.stepLen = this.len / this.allTimes;
		}
	}
};
...
TimeControl.prototype.UpDown = function (val) {
	...
	if (cTimes > this.allTimes && val > 0) {
		cTimes = this.allTimes;
		result = 2;
	}
	this.setLen(cTimes);
