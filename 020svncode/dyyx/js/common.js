...
var MAPPort = "554";
//var portalIP = "172.30.1.32";
var portalIP = "10.9.218.102";
var portalPort = "8080";
...
function getUserId () { //获取userId
  ...
  // try {
    ...
    console.log('commonjs---getGlobalVar--userId'+getGlobalVar('userId'))
    if(userId == "undefined" || userId == "" || userId == null|| userId == ''||userId === undefined){
      userId = 'maanshan'
    }
  // } catch (err) {
  // }
  console.log('common.js---userId'+userId)
  return userId ;//现网用88888888888888888，（之前）测试用0，后来maanshan
}
...
function setGlobalVar (_sName, _sValue) {
  //console.log("CommonJs_setGlobalVar" + _sName + "：" + _sValue)
  try {
    _sValue = _sValue + "";
...
function getGlobalVar (_sName) {
  ...
  // console.log("CommnonJs_getGlobalVar" + _sName + "：" + result)
  return result;
}
...
function cardBachu () {
  setGlobalVar('userId', '8120010480205746');//现网用8120010480205746，之前测试版本8120010480205746/maanshan，svn上88888888888888888
}
