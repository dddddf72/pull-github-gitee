...
var ROC_IRKEY_ASTERISK      = 318   /*0x0197,  遥控器上的星号键*/
...
//定义键 0528
var GD_KEY_MAIL           =39//短信
var GD_KEY_GAME           =73//游戏
var GD_KEY_TV             =44//电视键
var GD_KEY_AUDIO          =59//广播
var GD_KEY_MOVE           =47//点播
var GD_KEY_INFO           =46//信息
var GD_KEY_JIAOTI         =69//交替
var DG_KEY_JINGHUA        =67//静画
var DG_KEY_XIANSHI        =3880//显示
var DG_KEY_SHENGDAO       =313//声道
var DG_KEY_JINGYIN        =119//静音
var DG_KEY_XIAI           =76//喜爱
...
var ROC_IRKEY_FUN8          = 47   /*0x0306,  天津项目中代表 :  [停止] 键 */
...
var ROC_SYSEVENT_SWITCH_SCREEN                        = 13002;  //三屏互动，切屏



/************* 主应用自定义消息 **************/
var CUSTOM_SEARCH_DEL_TEMP_FAILED=80001;//删除缓存失败
var CUSTOM_SEARCH_FAILED = 80002; //搜索失败
var CUSTOM_SEARCH_STOP = 80012;//成功停止
var CUSTOM_SEARCH_SAVE_FAILED = 80006;//保存失败
var CUSTOM_SEARCH_SAVE_SUCC = 80007;//保存成功
var CUSTOM_SEARCH_TUNE_FAILED = 80008;//锁频失败
var CUSTOM_SEARCH_TUNE_SUCC = 80009;//锁频成功
var CUSTOM_SEARCH_READY =80010;//搜索到节目
...
$getCAMsgInfo = function(event){
    var val = event.which;
    var p2 = event.modifiers;
    if(val ==11505 || val == 11309){ //11505: "请插卡", 11309:"没有授权"
        var text = SysSetting.getEventInfo(p2)
        return {"type": 0, "text": text};
    }
    else if(val ==ROC_SYSEVENT_CAEXT_INQUIRE_IPP){
        return {"type":1, "text": ""};
    }
    else{
        return null;
