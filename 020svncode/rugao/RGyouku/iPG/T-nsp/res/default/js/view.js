...
var View = (function () {
    ...
    View.prototype.insertAfter = function (a) {
        this.a = this.a.concat(Array.prototype.slice.call(a));
    ...
    View.prototype.insertBefore = function (a) {
        this.a = Array.prototype.slice.call(a).concat(this.a);
